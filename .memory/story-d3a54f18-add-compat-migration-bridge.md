...
updated_at: 2026-03-20T22:25:00+10:30
status: in-progress
epic_id: a7c9d4f2
priority: high
story_points: 3
...
| AC3 | Fallback to legacy on no match | Dedicated migrated-legacy-fallback integration test (worktree -> worktrees["**"]) | not-implemented |
...
- [ ] Add explicit fallback-to-legacy integration assertion after migration (`worktree` -> `worktrees["**"]`) and link it in E2E table.
